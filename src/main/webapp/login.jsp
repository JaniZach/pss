...
<body>
	<div id="login_center">
		<div id="login_area">
			<div id="login_box">
				<div id="login_form">
					<s:form id="submitForm" namespace="/" action="login">
						<div id="login_tip">
							<s:if test="hasActionErrors()">
								<span id="login_err" class="sty_txt2"><s:property value="actionErrors"/></span>
							</s:if>
						</div>
						<div>
							 用户名：<s:textfield name="username" class="username" id="name"/>
						</div>
						<div>
