...
<head>
    ...
    <script type="text/javascript" src="/js/system/stockIncomeBill_show.js"></script>
</head>
<s:debug/>
<body>
            ...
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <s:textfield name="#_vdate" cssClass="ui_input_txt02"/>
                    </td>
                </tr>
                    <%--入库单明细--%>
                <tr>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td class="ui_text_lt">
                        &nbsp;<input id="backbutton" type="button" value="返回列表页面" class="ui_input_btn01"/>
                    </td>
                </tr>
            </table>
        </div>
