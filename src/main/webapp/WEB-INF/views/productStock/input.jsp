...
<s:form name="editForm" namespace="/" action="productStock_saveOrUpdate" method="post" id="editForm">
    <div id="container">
        <div id="nav_links">
            <span style="color: #1A5CC6;">货品库存编辑</span>
            <div id="page_close">
                <a>
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <s:hidden name="productStock.id"></s:hidden>
                            <tr>
                                <td class="ui_text_rt" width="140">库存价值</td>
                                <td class="ui_text_lt">
                                    <s:textfield name="productStock.amount" cssClass="ui_input_txt02" ></s:textfield>
                                </td>
                            </tr>
                            <tr>
                                <td class="ui_text_rt" width="140">库存货品</td>
                                <td class="ui_text_lt">
                            ...
                            <tr>
                                <td class="ui_text_rt" width="140">货品价格</td>
                                <td class="ui_text_lt">
