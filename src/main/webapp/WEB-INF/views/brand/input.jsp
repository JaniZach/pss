...
<s:form name="editForm" namespace="/" action="brand_saveOrUpdate" method="post" id="editForm">
    <div id="container">
        <div id="nav_links">
            <span style="color: #1A5CC6;">品牌管理编辑</span>
            <div id="page_close">
                <a>
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                <s:hidden name="brand.id"></s:hidden>
                <tr>
                    <td class="ui_text_rt" width="140">品牌名称</td>
                    <td class="ui_text_lt">
                        <s:textfield name="brand.name" cssClass="ui_input_txt02"></s:textfield>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">品牌编码</td>
                    <td class="ui_text_lt">
                        <s:textfield name="brand.sn" cssClass="ui_input_txt02"></s:textfield>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
