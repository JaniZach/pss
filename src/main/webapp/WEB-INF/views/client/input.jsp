...
<s:form name="editForm" namespace="/" action="client_saveOrUpdate" method="post" id="editForm">
    <div id="container">
        <div id="nav_links">
            <span style="color: #1A5CC6;">客户管理编辑</span>
            <div id="page_close">
                <a>
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:textfield name="client.name" cssClass="ui_input_txt02"></s:textfield>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">客户编码</td>
                    <td class="ui_text_lt">
                        <s:textfield name="client.sn" cssClass="ui_input_txt02"></s:textfield>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt" width="140">联系电话</td>
                    <td class="ui_text_lt">
                        <s:textfield name="client.phone" cssClass="ui_input_txt02"></s:textfield>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
