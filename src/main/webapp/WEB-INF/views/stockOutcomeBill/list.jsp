...
<s:form id="searchForm" action="stockOutcomeBill" namespace="/" method="post">
    <div id="container">
            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_center">
                        ...
                        <s:textfield name="qo.endDate" class="ui_input_txt02 Wdate" value="%{#_endDate}"/>
                        出库仓库
                        <s:select list="#depots" listKey="id" listValue="name" name="qo.depotId"
                                  headerKey="-1" headerValue="全部" class="ui_select01"/>
                        客户
                        <s:select list="#clients" listKey="id" listValue="name" name="qo.clientId"
                                  headerKey="-1" headerValue="全部" class="ui_select01"/>
                        状态
                    ...
                    <div id="box_bottom">
                        ...
                        <input type="button" value="批量删除" class="ui_input_btn01 btn_batchDelete"
                               data-url="<s:url namespace="/" action="stockOutcomeBill_batchDelete"/>"/>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <s:if test="status==0">
                                ...
                                <td>
                                    <s:url namespace="/" action="stockOutcomeBill_audit" var="auditUrl">
                                        <s:param name="stockOutcomeBill.id" value="id"></s:param>
                                    </s:url>
